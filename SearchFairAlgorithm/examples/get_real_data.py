...
from aif360.datasets.meps_dataset_panel21_fy2016 import *

def get_meps_data(load_data_size=None):
    """Load the MEPS dataset.
    Source: See https://github.com/Trusted-AI/AIF360/blob/master/aif360/data/raw/meps/README.md
    ...
    X = meps.features
    y = np.asarray([i[0] for i in meps.labels])
    s = np.asarray([i[0] for i in meps.protected_attributes])
